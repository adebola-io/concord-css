console.log('streamline.app.vanilla.js imported.');
class StreamlineComponent {
    //Run all Streamline functions
    runAll(){
    ...
    // Add Header Navigation Drop-Down
    addDropDown() {
    ...
    // Set the usability of HTML atrribute 'hover-class'
    addHoverClasses () {
